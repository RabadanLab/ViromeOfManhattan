...
java -Xmx16g -jar ${d}/mitcr.jar -pset flex -level 3 -gene TRA tcr/both_mates.fastq tcr/alpha_chain.txt

echo beta chain [ `date` ] 
java -Xmx16g -jar ${d}/mitcr.jar -pset flex -level 3 -gene TRB tcr/both_mates.fastq tcr/beta_chain.txt
